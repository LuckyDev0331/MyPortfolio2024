export const projects = [
  {
    ...
    source: 'https://github.com/LuckyDev0331/Diamond-NFT-Mini-Game',
...

  {
    ...
    source: 'https://github.com/LuckyDev0331/NFT-Rental-Marketplace',
  ...
  
  {
    ...
    source: 'https://github.com/LuckyDev0331/DeFi-Yield-Farming-Dapp',
...

  {
    ...
    description: "🔥Full Stack DAO Dapp with EIP-1167🔥 DAO members can create a proposal to purchase NFT from NFT-marketplace. 10 minutes is the voting period for each proposal. DAO Members can vote on the proposal. After voting period, proposal can be executed ⏩ NFT is purchased from the NFT Marketplace using ETH in the proposal contract.",
      ...
      tags: ['Solidity', 'Hardhat', 'Ethers.js', 'Next.js'],
    source: 'https://github.com/LuckyDev0331/fullstack-dao-dapp',
...

  {
    ...
    source: 'https://github.com/LuckyDev0331/Dutch-Auction-ERC20-Factory',
    visit: 'https://github.com/LuckyDev0331/Dutch-Auction-ERC20-Factory',
    id: 4,
  },

  {
    ...
    tags: ['Solidity', 'Hardhat', 'Ethers.js', 'React'],
    source: 'https://github.com/LuckyDev0331/NFT-Ticketing-System-Frontend ',
  ...
  
  {
    ...
    source: 'https://github.com/LuckyDev0331/Aave-FlashLoan',
    visit: 'https://github.com/LuckyDev0331/Aave-FlashLoan',
    id: 6,
  },
  
  {
    ...
    tags: ['Solidity', 'Hardhat', 'Ethers.js', 'React'],
    source: 'https://github.com/LuckyDev0331/wave-portal',
    visit: 'https://github.com/LuckyDev0331/wave-portal',
    id: 7,
  },
  
  {
    ...
    description: "Dockerized Blockchain built from scratch in Python to better understand how a blockchain works. I learnt how to verify & add Txns to a Block, how Blocks are validated & verified before adding it to Blockchain. I also learnt how Mining, Proof of Work, Signing, Verification, and how a Miner is Rewarded",
      ...
      tags: ['Python', 'Docker'],
    source: 'https://github.com/LuckyDev0331/PyChain',
    visit: 'https://github.com/LuckyDev0331/PyChain',
    id: 8,
  },
  
  {
    ...
    tags: ['Python', 'Docker'],
    source: 'https://github.com/LuckyDev0331/PyCryption',
    visit: 'https://github.com/LuckyDev0331/PyCryption',
    id: 9,
  },
